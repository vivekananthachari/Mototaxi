...
public class Service_booking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyListAdaptervechileserice adapter = new MyListAdaptervechileserice(myListDatanew, Service_booking.this);
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.page_1:
                    Intent a = new Intent(Service_booking.this,   Dashboard.class);
                    a.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    startActivity(a);
                    Service_booking.this.finish();

                    // start activity 1
                    return true;
                case R.id.page_2:
                    Intent a2 = new Intent(Service_booking.this,   Vechile.class);
                    ...
                    return true;
                case R.id.page_3:
                    Intent a1 = new Intent(Service_booking.this, history.class);
                ...
                case R.id.page_4:
                    // start activity 2
                    Intent a3 = new Intent(Service_booking.this, Analtic.class);
                ...
                default:
                    //default intent
                    Intent a5 = new Intent(Service_booking.this,   Dashboard.class);
