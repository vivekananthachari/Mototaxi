...
public class Noofdelearlist extends AppCompatActivity {
    GridView coursesGV;
    GridView tyrelist;
    GridView repairlist;
    GridView vechlist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_noofdelearlist);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent a = new Intent(Noofdelearlist.this, Maplocation.class);
                a.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(a);
                Noofdelearlist.this.finish();
            }
        });
