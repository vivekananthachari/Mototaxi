...
public abstract class CommService
{
	...
	synchronized void setState(STATE state)
	{
		...
		mHandler.obtainMessage(MainActivitynew.MESSAGE_STATE_CHANGE, state).sendToTarget();
	}
	...
	void connectionFailed()
	{
		...
		Message msg = mHandler.obtainMessage(MainActivitynew.MESSAGE_TOAST);
		Bundle bundle = new Bundle();
		bundle.putString(MainActivitynew.TOAST, mContext.getString(R.string.unabletoconnect));
		msg.setData(bundle);
	...
	void connectionLost()
	{
		...
		Message msg = mHandler.obtainMessage(MainActivitynew.MESSAGE_TOAST);
		Bundle bundle = new Bundle();
		bundle.putString(MainActivitynew.TOAST, mContext.getString(R.string.connectionlost));
		msg.setData(bundle);
		mHandler.sendMessage(msg);
	}
	...
	void connectionEstablished(String deviceName)
	{
		...
		Message msg = mHandler.obtainMessage(MainActivitynew.MESSAGE_DEVICE_NAME);
		Bundle bundle = new Bundle();
		bundle.putString(MainActivitynew.DEVICE_NAME, deviceName);
		msg.setData(bundle);
		mHandler.sendMessage(msg);
