 ...
 */
public class MainActivitynew extends PluginManager
        ...
        AbsListView.MultiChoiceModeListener
{
    ...
    public synchronized void pvChanged(PvChangeEvent event)
    {
        ...
        Message msg = mHandler.obtainMessage(MainActivitynew.MESSAGE_DATA_ITEMS_CHANGED);
    ...
    protected void setNightMode(boolean nightMode)
    {
        ...
        MainActivitynew.nightMode = nightMode;
    ...
    private void setAutoHider(boolean active)
    {
        ...
        if (active)
        {
            int timeout = getPrefsInt(MainActivitynew.PREF_AUTOHIDE_DELAY, 15);
    ...
    private void setupLoggers()
    {
        ...
        try
        {
            ...
            logFileHandler = new FileHandler(logFileName.concat("/log.%g.txt"),
                    250 * 1024 * 1024,
                    5,
                    false);
    ...
    private void setLogLevels()
    {
        ...
        MainActivitynew.rootLogger.setLevel(level);
    }
